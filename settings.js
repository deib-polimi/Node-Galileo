...
module.exports = {
    ...
    // the udp port for inter-device node communication
    udpNodesPort: 33333,

    // the udp port for inter-device dashboard communication
    //udpDashboardPort: 44444,
    ...
    // By default, the Node-RED dashboard UI is available at http://localhost:1880/dashboard
    // The following property can be used to specifiy a different path.
    httpDashboardRoot: '/dashboard',
